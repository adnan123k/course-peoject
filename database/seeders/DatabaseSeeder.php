...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::insert('insert into users ( password,email,role_id,name,created_at,updated_at) values (?,?,?,?,?,?)', ['test123', 'adnan@adnan.com', 1, 'adnan', date("Y-m-d h:i:sa"), date("Y-m-d h:i:sa")]); }
}
